...
from PyQt5.QtCore import QSettings, QTranslator, qVersion, pyqtSignal,\
    QCoreApplication, QFileInfo, QDir, QUrl, QTimer, Qt, QObject 
from PyQt5.QtWidgets import QAction, QListWidgetItem, QFileDialog, QDialogButtonBox, \
    QMenu, QMessageBox, QApplication
from PyQt5.QtGui import QIcon, QPainter, QCursor, QDesktopServices
